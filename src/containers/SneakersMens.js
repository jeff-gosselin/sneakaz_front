...
class SneakersMens extends Component {
	componentDidMount() {
    ...
    return (
			...
			<Switch>
				...
				<Route path='/mens' render={() => {return <div className="sneaker-wrapper">{sneakerItems}</div>}} />
...
export default connect(mapStateToProps)(withRouter(SneakersMens));
